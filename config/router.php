...
function route($route, $path_to_include){
  $BASE_PATH = str_replace('config', '', __DIR__);
  ...
  $BASE_DIRECTORY = str_replace('/routes.php', '', $_SERVER['SCRIPT_NAME']);
  $request_url = str_replace($BASE_DIRECTORY, '', $_SERVER['REQUEST_URI']);
